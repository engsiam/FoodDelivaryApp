  ...
  const reviews = [
    {
      ...
      avatar:
        "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20a%20young%20man%20with%20short%20brown%20hair%20and%20glasses%2C%20neutral%20expression%2C%20professional%20lighting%2C%20high%20quality%20portrait%20photography%2C%20isolated%20on%20light%20background&width=40&height=40&seq=5&orientation=squarish",
      rating: 5,
      date: "April 12, 2025",
    ...
    },
    {
      ...
      avatar:
        "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20a%20young%20woman%20with%20shoulder%20length%20blonde%20hair%2C%20neutral%20expression%2C%20professional%20lighting%2C%20high%20quality%20portrait%20photography%2C%20isolated%20on%20light%20background&width=40&height=40&seq=6&orientation=squarish",
      rating: 4,
      date: "April 5, 2025",
  ...
  const relatedProducts = [
    {
      ...
      rating: 4.6,
      image:
        "https://readdy.ai/api/search-image?query=wireless%20sport%20earbuds%20in%20charging%20case%2C%20professional%20product%20photography%20on%20simple%20light%20gray%20background%2C%20ultra%20high%20resolution%2C%20detailed%20texture%20visible%2C%20studio%20lighting%2C%20centered%20composition%2C%20photorealistic&width=120&height=120&seq=7&orientation=squarish",
    },
    {
      id: 2,
      ...
      rating: 4.9,
      image:
        "https://readdy.ai/api/search-image?query=professional%20studio%20headphones%20with%20coiled%20cable%2C%20professional%20product%20photography%20on%20simple%20light%20gray%20background%2C%20ultra%20high%20resolution%2C%20detailed%20texture%20visible%2C%20studio%20lighting%2C%20centered%20composition%2C%20photorealistic&width=120&height=120&seq=8&orientation=squarish",
    },
    {
      id: 3,
      ...
      rating: 4.3,
      image:
        "https://readdy.ai/api/search-image?query=compact%20travel%20earphones%20with%20carrying%20case%2C%20professional%20product%20photography%20on%20simple%20light%20gray%20background%2C%20ultra%20high%20resolution%2C%20detailed%20texture%20visible%2C%20studio%20lighting%2C%20centered%20composition%2C%20photorealistic&width=120&height=120&seq=9&orientation=squarish",
    },
  ];
  const questions = [
    {
      ...
      answer:
        "With active noise cancellation enabled, the battery lasts approximately 30 hours on a single charge. Without ANC, you can get up to 40 hours of playback time.",
    ...
    },
    {
      id: 2,
      question:
        "Are these headphones compatible with iPhone and Android devices?",
      answer:
        "Yes, these headphones are compatible with both iPhone and Android devices. They connect via Bluetooth 5.2 and support multipoint connection for seamless switching between devices.",
    ...
    >
      ...
      <div className="pt-14 pb-16">
        ...
        <div className="px-4 mt-5">
          ...
          <div className="flex items-end mt-2">
            ...
            <span className="ml-2 text-base line-through text-gray-500 tracking-wide">
              $159.99
            </span>
            <span className="ml-2 text-sm font-medium text-white bg-red-500 px-2 py-0.5 rounded tracking-wider">
              20% OFF
            </span>
          </div>
          <div className="flex items-center mt-3">
            ...
            <button className="ml-2 text-sm text-[#9641c1] cursor-pointer">
              See all
            </button>
          </div>
        </div>
          ...
          <div className="flex mt-2 space-x-3">
            {colorOptions.map((color) => (
              <button
                ...
                className={`w-10 h-10 rounded-full cursor-pointer flex items-center justify-center !rounded-button ${
                  selectedColor === color.name
                    ? "ring-2 ring-offset-2 ring-[#9641c1]"
                    : ""
                }`}
        ...
        <div className="px-4 mt-6">
          ...
          >
            ...
            <i
              className={`fas fa-chevron-${
                expandedSection === "features" ? "up" : "down"
              } text-gray-500`}
            ></i>
          </div>
          ...
          >
            ...
            <i
              className={`fas fa-chevron-${
                expandedSection === "description" ? "up" : "down"
              } text-gray-500`}
            ></i>
          </div>
          {expandedSection === "description" && (
            <div className="pb-3 text-sm text-gray-600">
              <p>
                ...
                active noise cancellation technology that blocks out external
                noise, allowing you to focus on your music or calls.
              </p>
              <p className="mt-2">
                With up to 40 hours of battery life, you can enjoy your favorite
                content all day long. The intuitive touch controls make it easy
                to adjust volume, skip tracks, and answer calls without reaching
                for your device.
              </p>
            </div>
          )}
        ...
        <div className="px-4 mt-8">
          <div className="flex justify-between items-center">
            ...
            <button className="text-sm text-[#9641c1] cursor-pointer">
              View All
            </button>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    <div className="flex items-center">
                      ...
                      {review.verified && (
                        <span className="ml-2 text-xs bg-[#9641c1]/10 text-[#9641c1] px-1.5 py-0.5 rounded">
                          Verified Purchase
                        </span>
                      )}
                    </div>
        ...
        {/* Related Products */}
        <div className="mt-8">
          <h2 className="px-4 text-xl font-semibold text-gray-900 tracking-tight">
            You May Also Like
          </h2>
          <div className="mt-4 pl-4 flex space-x-4 overflow-x-auto hide-scrollbar pb-4">
            {relatedProducts.map((product) => (
              ...
              >
                ...
                <h3 className="mt-2 text-base font-semibold text-gray-900 tracking-wide line-clamp-1">
                  {product.name}
                </h3>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-sm border-t border-gray-200 px-4 py-3 flex items-center justify-between z-40">
        ...
        <div className="flex-1 flex space-x-2 ml-3">
          ...
          <a
            href="https://readdy.ai/home/b79e29f1-1f47-4bb0-bee4-af561efbbbd4/18600fc4-2405-4895-b326-6ee1028fcd93"
            data-readdy="true"
            className="flex-1"
          >
